    ...
    class kt_api_manager {
        ...
        public function kt_api_key_field() {
            ...
            if ( $this->kt_options[$this->kt_api_key] ) {
                echo '<span class="ktap-icon-pos"><i class="kt-icon-checkmark" style="font-size:20px; color:green;"></i></span>';
            } else {
                echo '<span class="ktap-icon-pos"><i class="kt-icon-warning" style="font-size:20px; color:orange;"></a></span>';
            }
        }
