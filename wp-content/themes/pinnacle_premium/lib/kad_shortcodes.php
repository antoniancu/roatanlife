...
function kad_shortcode_button_scripts(){
	...
	wp_enqueue_style('kad-shortcode-css', get_template_directory_uri() . '/lib/kad_shortcodes/css/kad-short-pop.css', false, '1.9.0'); 
	wp_enqueue_script('kad_shortcode',get_template_directory_uri() . '/lib/kad_shortcodes/js/min/kad_shortcode_pop.min.js',array( 'jquery', 'wp-color-picker' ),'1.9.0 ', TRUE);
}
